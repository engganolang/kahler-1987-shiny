...
Please cite the original source [@kähler1987] (if in APA7^th^) and the particular version of the digitised dictionary [@rajeg_kahler] (in [DataCite](https://support.datacite.org/docs/data-citation)) as follows:
...
For future updates and version of records, please check the [Releases](https://github.com/engganolang/kahler-1987-shiny/releases) page on this GitHub repository.

## Overview

This repository hosts the source R codes for building the Shiny web application serving the retro-digitised[^1] Enggano-German Dictionary [@rajeg_kahler] by Hans Kähler [-@kähler1987].
