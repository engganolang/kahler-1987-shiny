...
title: "R codes for the web application serving the dataset from \"Retro-digitised Enggano-German dictionary derived from Kähler’s (1987) “Enggano-Deutsches Wörterbuch”\""
...
Please cite the original source [@kähler1987] (if in APA7^th^) and the particular version of the digitised dictionary dataset [@rajeg_kahler] (in [DataCite](https://support.datacite.org/docs/data-citation)) as follows:
...
This repository hosts the source R codes for building [the Enggano-German Dictionary online web-application](https://enggano.shinyapps.io/enggano-german-dictionary/) serving the retro-digitised[^1] Enggano-German Dictionary dataset [@rajeg_kahler] by Hans Kähler [-@kähler1987].
